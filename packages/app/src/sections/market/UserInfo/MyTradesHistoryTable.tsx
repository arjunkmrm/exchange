...
import useGetMyTradeHistory from 'queries/futures/useGetMyTradeHistory'
...
const MyTradesHistoryTable: FC<TradesHistoryTableProps> = ({ mobile, display }) => {
	const { t } = useTranslation()
	const marketKey = useAppSelector(selectCurrentMarketAsset)
	const futuresTradesQuery = useGetMyTradeHistory(marketKey)
...
export default MyTradesHistoryTable
