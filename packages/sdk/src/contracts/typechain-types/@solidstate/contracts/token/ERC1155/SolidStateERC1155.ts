...
export interface SolidStateERC1155Interface extends utils.Interface {
  functions: {
...
export interface SolidStateERC1155 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SolidStateERC1155Interface;
