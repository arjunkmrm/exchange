...
import type {
  SolidStateERC1155,
  SolidStateERC1155Interface,
} from "../../../../../@solidstate/contracts/token/ERC1155/SolidStateERC1155";
...
export class SolidStateERC1155__factory {
  static readonly abi = _abi;
  static createInterface(): SolidStateERC1155Interface {
    return new utils.Interface(_abi) as SolidStateERC1155Interface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): SolidStateERC1155 {
    return new Contract(address, _abi, signerOrProvider) as SolidStateERC1155;
  }
}
